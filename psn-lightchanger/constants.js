...
export const CORRECT_FUNCITON_CALLED_ONENTER_TEST = "OnEnter triggers Correct Function(S)"
export const CORRECT_FUNCITON_CALLED_ONCLICK_TEST = "OnClick Triggers Correct Function(s)"
export const CORRECT_TEXT_TEST = "Renders with Correct Text"

export const EXPECTED_VALUES_IN_SESSION_STORAGE_TEST = "Expected values are In SessionStorage"
